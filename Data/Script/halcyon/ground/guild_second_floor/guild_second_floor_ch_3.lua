...
function guild_second_floor_ch_3.OutlawTutorialScene()
	...
	UI:WaitShowDialogue(cranidos:GetDisplayName() .. ",[pause=10] can you help me choose a good outla-a-a-aw?")
	...
	UI:WaitShowDialogue("Thank you for the help,[pause=10] " .. mareep:GetDisplayName() .. "!")

...
function guild_second_floor_ch_2.CameruptRequestCutscene()
	...
	UI:WaitShowDialogue("This is the Job Bulletin Board.[pause=0] Requests from Pokémon from all over are posted here daily.")
	...
	UI:WaitShowDialogue("Some items,[pause=10] such as the " .. scarf_name .. " the Guildmaster gave you,[pause=10] are special and cannot be lost.")

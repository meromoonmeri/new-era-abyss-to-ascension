...
function guild_heros_room_ch_3.PostOutlawBedtalkFirstHalf()
	...
	UI:WaitShowDialogue("I'm worn out.[pause=0] Today was a lot more than I had bargained for.")
	...
	UI:WaitShowDialogue("But it turned out he wasn't such a bad guy.[pause=0] Just someone who made a bad choice.")
	...
	UI:WaitShowDialogue("If he hasn't caught me trying to sneak into " .. zone:GetColoredName() .. " lately,[pause=10] he'd tell me one of them.")
	...
	UI:WaitShowDialogue("One time,[pause=10] he told me about the legend of the Anima Cores.[pause=0] That story's my favorite!")
...
function guild_heros_room_ch_3.DemoThanks()
	...
	UI:WaitShowDialogue("If you're interesting in contributing to New Era : Abyss to Ascension as well, please let Palika know!")

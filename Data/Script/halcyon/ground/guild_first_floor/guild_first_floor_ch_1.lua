...
function guild_first_floor_ch_1.EnterGuild()
	...
	GAME:WaitFrames(12)
	UI:WaitShowDialogue("This tree has been here as long as anyone can remember...[br]...But the guild itself is about as old I am.")
	...
	UI:WaitShowDialogue("I know all of this might be overwhelming and sudden given your amnesia,[pause=10] but...")
	UI:WaitShowDialogue("We shouldn't tell anyone that you were a human or that you lost your memory.")
	UI:WaitShowDialogue("I believe that you were a human at one point...")

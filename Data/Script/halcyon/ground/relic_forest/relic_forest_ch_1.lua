...
--[color=#00FFFF]Erleuchtet[color]
	...
	GAME:WaitFrames(20)
	UI:SetSpeakerEmotion("Worried")
	UI:WaitShowDialogue(STRINGS:Format("That's worrisome...[pause=0] How would [a/an] " .. hero_species .. " end up conked out here with no memory of it?"))
	...
	GAME:WaitFrames(40)
	GeneralFunctions.HeroDialogue(hero, STRINGS:Format("(Wh-what!?[pause=0] I am [a/an] " .. hero_species .. "!)"), "Surprised")
	GAME:WaitFrames(20)
	GeneralFunctions.HeroDialogue(hero, STRINGS:Format("(This must be a dream![pause=0] There's no way I really turned into [a/an] " .. hero_species .. "!)"), "Surprised")
	...
	UI:WaitShowDialogue(STRINGS:Format("Besides,[pause=10] you look like [a/an] " ..  hero_species .. " to me..."))

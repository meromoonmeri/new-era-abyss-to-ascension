...
function crooked_den_ch_3.FirstPreBossScene()
	...
	UI:SetSpeaker(partner)
	UI:SetSpeakerEmotion("Worried")
	UI:WaitShowDialogue("Hmm...[pause=0] You don't seem like a bad Pokémon to me...[pause=0] How'd you end up with a bounty,[pause=10] anyway?")
	...
	UI:WaitShowDialogue("So I've tried to find anything I could in my travels that would help me become beautiful.")
	
	GAME:WaitFrames(20)
	UI:SetSpeakerEmotion("Normal")
	UI:WaitShowDialogue("One day I came across a shopkeeper who was selling the most gorgeous scarf I had ever seen.")
	UI:WaitShowDialogue("I thought that maybe with a scarf like that,[pause=10] I could finally look how I've always wanted to!")
	UI:WaitShowDialogue("So,[pause=10] I asked him how much it was.")
	
	GAME:WaitFrames(20)
	UI:SetSpeakerEmotion("Sad")
	UI:WaitShowDialogue("The price he told me was staggering...[pause=0] I didn't have that kind of money!")
	UI:WaitShowDialogue("It was just so beautiful though...[pause=0] I had to have it![pause=0]\nI couldn't help but steal it.")
	UI:WaitShowDialogue("I felt so bad for taking it afterwards...[pause=0] I knew what I did was wrong.")
	UI:WaitShowDialogue("But it was too late.[pause=0] I had stolen something,[pause=10] and became a wanted Pokémon.")
	UI:WaitShowDialogue("I ran away,[pause=10] and hid here hoping the bandits would deter others from looking for me.")
	UI:SetSpeakerEmotion("Stunned")
	UI:WaitShowDialogue("Seems like that didn't work though,[pause=10] huh?")
	
	GAME:WaitFrames(20)
	UI:SetSpeaker(partner)
	UI:SetSpeakerEmotion("Worried")
	UI:WaitShowDialogue("Why didn't you just give it back?[pause=0] Maybe the shopkeeper would have forgiven you?")
	...
	GAME:WaitFrames(20)
	UI:SetSpeaker(luxio)
	UI:WaitShowDialogue("When we spoke with you chumps earlier,[pause=10] you mentioned you were headed off on your first outlaw job.")
...
function crooked_den_ch_3.DefeatedBoss()
	...
	UI:WaitShowDialogue("That means a lot to me...[pause=0] Thank you...")

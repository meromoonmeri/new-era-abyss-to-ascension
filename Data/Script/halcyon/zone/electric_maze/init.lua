...
-- Map Callbacks
--------------------------------------------------
function electric_maze.Init(zone)
...
function electric_maze.ExitSegment(zone, result, rescue, segmentID, mapID)
  DEBUG.EnableDbgCoro() --Enable debugging this coroutine
  PrintInfo("=>> ExitSegment_electric_maze (Electric Maze) result "..tostring(result).." segment "..tostring(segmentID))
	...
	--flag electric_maze as last dojo zone
	SV.Dojo.LastZone = "electric_maze"
